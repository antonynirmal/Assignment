...
public SqlSessionFactory sqlSessionFactory() throws Exception {
    ...
    sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:my/sample/mapper/mysql/*.xml"));
...
public MapperScannerConfigurer sqlMapperScannerConfigurer() throws Exception {
    ...
    configurer.setBasePackage("my.sample.mapper.mysql");
    configurer.setSqlSessionFactoryBeanName("sqlSessionFactory");
    configurer.setAnnotationClass(MySqlDataSource.class);
    return configurer;
}
